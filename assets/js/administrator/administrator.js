...
Tidak ada poster kegiatan`
    ...
    $('#infografis_table_mitra').DataTable({
        ...
        columns: [{
...

            {
                ...
                render: function(data) {
                    return `
					<button id='btn-edit-infografis-table-mitra' type='submit' class='btn btn-warning btn-block' data-id='${data}'>Edit</button>
					<button id='btn-reject-infografis-table-mitra' type='submit' class='btn btn-danger btn-block' data-id='${data}'>Hapus</button>`
                },
            },
        ]
    })

    $('table').on('click', '#btn-edit-infografis-table-mitra', function() {
    ...
    $('table').on('click', '#btn-reject-infografis-table-mitra', function() {
        if ($('#infografis_table_mitra').length > 0) {
            const id = $(this).data('id')
    ...
    $('#infografis_table_balai').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_balai`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
...

            {
                ...
                render: function(data) {
                    return `
					<button id='btn-edit-infografis-table-balai' type='submit' class='btn btn-warning btn-block' data-id='${data}'>Edit</button>
					<button id='btn-reject-infografis-table-balai' type='submit' class='btn btn-danger btn-block' data-id='${data}'>Hapus</button>`
                },
            },
        ]
    })

    $('table').on('click', '#btn-edit-infografis-table-balai', function() {
        if ($('#infografis_table_balai').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_mitra/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
    ...
    $('table').on('click', '#btn-reject-infografis-table-balai', function() {
        if ($('#infografis_table_balai').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/delete_infografis_mitra/${id}`)
            $('#modal-delete-infografis-mitra').modal('show')
    ...
    $('#infografis_table_opd').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_opd`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
...

            {
                ...
                render: function(data) {
                    return `
					<button id='btn-edit-infografis-table-opd' type='submit' class='btn btn-warning btn-block' data-id='${data}'>Edit</button>
					<button id='btn-reject-infografis-table-opd' type='submit' class='btn btn-danger btn-block' data-id='${data}'>Hapus</button>`
                },
            },
        ]
    })

    $('table').on('click', '#btn-edit-infografis-table-opd', function() {
        if ($('#infografis_table_opd').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_mitra/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
    ...
    $('table').on('click', '#btn-reject-infografis-table-opd', function() {
        if ($('#infografis_table_opd').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/delete_infografis_mitra/${id}`)
            $('#modal-delete-infografis-mitra').modal('show')
    ...
    $('#infografis_table_vokasi').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_vokasi`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
...

            {
                ...
                render: function(data) {
                    return `
					<button id='btn-edit-infografis-table-vokasi' type='submit' class='btn btn-warning btn-block' data-id='${data}'>Edit</button>
					<button id='btn-reject-infografis-table-vokasi' type='submit' class='btn btn-danger btn-block' data-id='${data}'>Hapus</button>`
                },
            },
        ]
    })

    $('table').on('click', '#btn-edit-infografis-table-vokasi', function() {
        if ($('#infografis_table_vokasi').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_mitra/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
    ...
    $('table').on('click', '#btn-reject-infografis-table-vokasi', function() {
        if ($('#infografis_table_vokasi').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/delete_infografis_mitra/${id}`)
            $('#modal-delete-infografis-mitra').modal('show')
    ...
    $('#infografis_table_asosiasi_profesi').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_asosiasi_profesi`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
...

            {
                ...
                render: function(data) {
                    return `
					<button id='btn-edit-infografis-table-asosiasi_profesi' type='submit' class='btn btn-warning btn-block' data-id='${data}'>Edit</button>
					<button id='btn-reject-infografis-table-asosiasi_profesi' type='submit' class='btn btn-danger btn-block' data-id='${data}'>Hapus</button>`
                },
            },
        ]
    })

    $('table').on('click', '#btn-edit-infografis-table-asosiasi_profesi', function() {
        if ($('#infografis_table_asosiasi_profesi').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_mitra/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
    ...
    $('table').on('click', '#btn-reject-infografis-table-asosiasi_profesi', function() {
        if ($('#infografis_table_asosiasi_profesi').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/delete_infografis_mitra/${id}`)
            $('#modal-delete-infografis-mitra').modal('show')
    ...
    $('#infografis_table_asosiasi_bujk').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_asosiasi_bujk`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
...

            {
                ...
                render: function(data) {
                    return `
					<button id='btn-edit-infografis-table-asosiasi_bujk' type='submit' class='btn btn-warning btn-block' data-id='${data}'>Edit</button>
					<button id='btn-reject-infografis-table-asosiasi_bujk' type='submit' class='btn btn-danger btn-block' data-id='${data}'>Hapus</button>`
                },
            },
        ]
    })

    $('table').on('click', '#btn-edit-infografis-table-asosiasi_bujk', function() {
        if ($('#infografis_table_asosiasi_bujk').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_mitra/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
    ...
    $('table').on('click', '#btn-reject-infografis-table-asosiasi_bujk', function() {
        if ($('#infografis_table_asosiasi_bujk').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/delete_infografis_mitra/${id}`)
            $('#modal-delete-infografis-mitra').modal('show')
    ...
    $('#infografis_table_lapas').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_lapas`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
...

            {
                ...
                render: function(data) {
                    return `
					<button id='btn-edit-infografis-table-lapas' type='submit' class='btn btn-warning btn-block' data-id='${data}'>Edit</button>
					<button id='btn-reject-infografis-table-lapas' type='submit' class='btn btn-danger btn-block' data-id='${data}'>Hapus</button>`
                },
            },
        ]
    })

    $('table').on('click', '#btn-edit-infografis-table-lapas', function() {
        if ($('#infografis_table_lapas').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_mitra/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
    ...
    $('table').on('click', '#btn-reject-infografis-table-lapas', function() {
        if ($('#infografis_table_lapas').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/delete_infografis_mitra/${id}`)
            $('#modal-delete-infografis-mitra').modal('show')
    ...
    $('#infografis_table_div').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_div`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
...

            {
                ...
                render: function(data) {
                    return `
					<button id='btn-edit-infografis-table-div' type='submit' class='btn btn-warning btn-block' data-id='${data}'>Edit</button>
					<button id='btn-reject-infografis-table-div' type='submit' class='btn btn-danger btn-block' data-id='${data}'>Hapus</button>`
                },
            },
        ]
    })

    $('table').on('click', '#btn-edit-infografis-table-div', function() {
        if ($('#infografis_table_div').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_instruktur/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
            $('#modal-edit-infografis-instruktur').modal('show')

        }
    })
    $('table').on('click', '#btn-reject-infografis-table-div', function() {
        if ($('#infografis_table_div').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/delete_infografis_instruktur/${id}`)
            $('#modal-delete-infografis-instruktur').modal('show')
        }
    })

    $('#infografis_table_dinv').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_dinv`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
...

            {
                ...
                render: function(data) {
                    return `
					<button id='btn-edit-infografis-table-dinv' type='submit' class='btn btn-warning btn-block' data-id='${data}'>Edit</button>
					<button id='btn-reject-infografis-table-dinv' type='submit' class='btn btn-danger btn-block' data-id='${data}'>Hapus</button>`
                },
            },
        ]
    })

    $('table').on('click', '#btn-edit-infografis-table-dinv', function() {
        if ($('#infografis_table_dinv').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_instruktur/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
    ...
    $('table').on('click', '#btn-reject-infografis-table-dinv', function() {
        if ($('#infografis_table_dinv').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/delete_infografis_instruktur/${id}`)
            $('#modal-delete-infografis-instruktur').modal('show')
    ...
    $('#infografis_table_aktk').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_aktk`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
...

            {
                ...
                render: function(data) {
                    return `
					<button id='btn-edit-infografis-table-asesor' type='submit' class='btn btn-warning btn-block' data-id='${data}'>Edit</button>
					<button id='btn-reject-infografis-table-asesor' type='submit' class='btn btn-danger btn-block' data-id='${data}'>Hapus</button>`
                },
            },
        ]
    })

    $('table').on('click', '#btn-edit-infografis-table-asesor', function() {
        if ($('#infografis_table_aktk').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_asesor/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
            $('#modal-edit-infografis-asesor').modal('show')

        }
    })
    $('table').on('click', '#btn-reject-infografis-table-asesor', function() {
        if ($('#infografis_table_aktk').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/delete_infografis_asesor/${id}`)
            $('#modal-delete-infografis-asesor').modal('show')
        }
    })

    $('#infografis_table_abu').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_abu`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
    ...
    $('table').on('click', '#btn-edit-infografis-table-asesor', function() {
        if ($('#infografis_table_abu').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_asesor/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
    ...
    $('#infografis_table_RPK').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_RPK`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
...

            {
                ...
                render: function(data) {
                    return `
					<button id='btn-edit-infografis-table-capaian_output' type='submit' class='btn btn-warning btn-block' data-id='${data}'>Edit</button>
					<button id='btn-reject-infografis-table-capaian_output' type='submit' class='btn btn-danger btn-block' data-id='${data}'>Hapus</button>`
                },
            },
        ]
    })

    $('table').on('click', '#btn-edit-infografis-table-capaian_output', function() {
        if ($('#infografis_table_RPK').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_capaian_output/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
            $('#modal-edit-infografis-capaian_output').modal('show')

        }
    })
    $('table').on('click', '#btn-reject-infografis-table-capaian_output', function() {
        if ($('#infografis_table_RPK').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/delete_infografis_capaian_output/${id}`)
            $('#modal-delete-infografis-capaian_output').modal('show')
        }
    })

    $('#infografis_table_RPBS').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_RPBS`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
    ...
    $('table').on('click', '#btn-edit-infografis-table-capaian_output', function() {
        if ($('#infografis_table_RPBS').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_capaian_output/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
    ...
    $('#infografis_table_PPK').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_PPK`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
    ...
    $('table').on('click', '#btn-edit-infografis-table-capaian_output', function() {
        if ($('#infografis_table_PPK').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_capaian_output/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
    ...
    $('#infografis_table_RPBWP').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_RPBWP`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
    ...
    $('table').on('click', '#btn-edit-infografis-table-capaian_output', function() {
        if ($('#infografis_table_RPBWP').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_capaian_output/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
    ...
    $('#infografis_table_RPKBMK').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_RPKBMK`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
    ...
    $('table').on('click', '#btn-edit-infografis-table-capaian_output', function() {
        if ($('#infografis_table_RPKBMK').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_capaian_output/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
    ...
    $('#infografis_table_RPKBJK').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_RPKBJK`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
    ...
    $('table').on('click', '#btn-edit-infografis-table-capaian_output', function() {
        if ($('#infografis_table_RPKBJK').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_capaian_output/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
    ...
    $('#infografis_table_TKK_AHLI').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_TKK_AHLI`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
    ...
    $('table').on('click', '#btn-edit-infografis-table-capaian_output', function() {
        if ($('#infografis_table_TKK_AHLI').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_capaian_output/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
    ...
    $('#infografis_table_TKK_TERAMPIL').DataTable({
        "order": [0, 'asc'],
        processing: true,
        serverSide: false,
        pagingType: "full_numbers",
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_table_TKK_TERAMPIL`,
            type: "GET",
        },
        columns: [{
                data: 'no_data_infografis',
    ...
    $('table').on('click', '#btn-edit-infografis-table-capaian_output', function() {
        if ($('#infografis_table_TKK_TERAMPIL').length > 0) {
            const id = $(this).data('id')
            $('form').attr('action', `${BASE_URL}Infografis_data/edit_infografis_capaian_output/${id}`)
            $('#edit_nama_infografis').val($(this).parent().siblings().eq(3).text())
            $('#edit_jumlah_infografis').val($(this).parent().siblings().eq(4).text())
    ...
    $('#infografis_file_mitra_table').DataTable({
        ...
        ajax: {
            url: `${BASE_URL}Infografis_data/infografis_file_mitra`,
            type: "GET",
        },
        columns: [{
    ...
    $('#btn-add-infografis-mitra').on('click', function() {
        $('form').attr('action', `${BASE_URL}Infografis_data/add_infografis_mitra`)
        $('#modal-tambah-infografis-mitra-master').modal('show');
    })

    $('#btn-add-infografis-instruktur').on('click', function() {
        $('form').attr('action', `${BASE_URL}Infografis_data/add_infografis_instruktur`)
        $('#modal-tambah-infografis-instruktur-master').modal('show');
    })

    $('#btn-add-infografis-asesor').on('click', function() {
