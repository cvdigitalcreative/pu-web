...
<body id="page-top">
    ...
    <!-- Tambah SE Kepala Daerah -->
    <div class="modal fade bd-example-modal-lg" id="modal-tambah-infografis-se_kepala_daerah-master" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalCenterTitle">Tambah SE Kepala Daerah</h4>
    ...
    <!-- Edit SE Kepala Daerah -->
    <div class="modal fade bd-example-modal-lg" id="modal-edit-infografis-se_kepala_daerah" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalCenterTitle">Edit SE Kepala Daerah</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade bd-example-modal-lg" id="modal-delete-infografis-se_kepala_daerah" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Hapus Item SE Kepala Daerah Ini?</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 font-weight-bold mb-4 mt-4">SE Kepala Daerah Data</h1>
                    </div>
                    ...
                    <div class="container-fluid mt-2 mb-4 container-background">
                        <div class="col d-flex justify-content-between button-field">
                            <div class="">
                                <button class="btn btn-primary btn-add-kegiatan mr-2 mt-4" id="btn-add-infografis-se_kepala_daerah"><img
                                        class="img-profile mr-2"
                                        src="<?= base_url('assets/icons/pupr-add-icon.svg') ?>">SE Kepala Daerah</button>
                        ...
                        <div class="card-body">
                            <div class="pb-4 pt-2">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#master-infografis-se_kepala_daerah" role="tab"
                                            data-toggle="tab">
                                            SE Kepala Daerah</a>
                                    </li>
                                </ul>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" role="tabpanel" id="master-infografis-se_kepala_daerah">
                                    <table id="infografis_table_se_kepala_daerah" class="display" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Provinsi</th>
