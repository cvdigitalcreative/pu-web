...
<body id="page-top">
    ...
    <!-- Tambah Asesor -->
    <div class="modal fade bd-example-modal-lg" id="modal-tambah-infografis-asesor-master" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalCenterTitle">Tambah Asesor</h4>
    ...
    <!-- Edit Asesor -->
    <div class="modal fade bd-example-modal-lg" id="modal-edit-infografis-asesor" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalCenterTitle">Edit Asesor</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <!-- End Modal Asesor -->
    <!-- Modal Delete Asesor -->
    <div class="modal fade bd-example-modal-lg" id="modal-delete-infografis-asesor" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Hapus Item Asesor Ini?</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h2 font-weight-bold mb-4 mt-4">Asesor Data</h1>
                    </div>
                    ...
                    <div class="container-fluid mt-2 mb-4 container-background">
                        <div class="col d-flex justify-content-between button-field">
                            <div class="">
                                <button class="btn btn-primary btn-add-kegiatan mr-2 mt-4" id="btn-add-infografis-asesor"><img
                                        class="img-profile mr-2"
                                        src="<?= base_url('assets/icons/pupr-add-icon.svg') ?>">Asesor</button>
                        ...
                        <div class="card-body">
                            <div class="pb-4 pt-2">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#master-infografis-aktk" role="tab"
                                            data-toggle="tab">
                                            AKTK</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" role="tabpanel" id="master-infografis-aktk">
                                    <table id="infografis_table_aktk" class="display" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Provinsi</th>
