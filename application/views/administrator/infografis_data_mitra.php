                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid mt-2 mb-4 container-background">
                        <div class="col d-flex justify-content-between button-field">
                            <div class="">
                                <button class="btn btn-primary btn-add-kegiatan mr-2 mt-4" id="btn-add-infografis-mitra"><img
                        ...
                        <div class="card-body">
                            <div class="pb-4 pt-2">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#master-infografis-opd" role="tab"
                                            data-toggle="tab">
                                            OPD</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#master-infografis-kso" role="tab"
                                            data-toggle="tab">
                                            KSO/PKS</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#master-infografis-mtu" role="tab"
                                            data-toggle="tab">
                                            MTU</a>
                                    </li>
                                </ul>
