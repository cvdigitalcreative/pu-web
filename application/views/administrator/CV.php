    ...
    <div style="padding: 1rem;">
        ...
        <table style="width: 100%;" cellspacing="10" cellpadding="4">
            ...
            <tr>
                <td>Alamat Rumah</td>
                <td>:</td>
                <td><?= $tenaga_ahli['alamat_lengkap']?></td>
            </tr>
            <tr>
                <td>E-Mail</td>
                <td>:</td>
            ...
            <tr>
                ...
                <td>:</td>
                <td>Jl. Prof. DR. Satrio No.164, RT.4/RW.4, Karet Semanggi, Kecamatan Setiabudi</td>
            </tr>
            <tr>
                <td>Jabatan</td>
                <td>:</td>
            ...
            <tr>
                ...
                <td style="text-align: justify; vertical-align: top;"><?php $index = 1;
